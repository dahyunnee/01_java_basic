...
//		if (finalScore >= 60) System.out.println("합격");
//		if (finalScore < 60) System.out.println("불합격");
		
		if (finalScore >= 60) 	System.out.println("합격");	//조건식이 true일 때 실행할 명령어
		else 	System.out.println("불합격");	//조건식이 false일 때 실행할 명령어
